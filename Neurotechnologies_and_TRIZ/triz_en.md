...
#### Step 5.2. Identify if the task as IFR-2 could be solved by analogy with non-standard tasks earlier solved using ARIZ.

#### Step 5.3. Identify if the task as IFR-2 could be solved using table of physical contradictions (PC) 

...
\title[Real-time neurosimulatons]{Real-time neurosimulatons} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\date{Machine Learning - Unconventional Computing conference} % Date, can be changed to a custom date

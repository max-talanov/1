...
\title[Real-time neurostimulation for spinal cord CPG]{Real-time neurostimulation for spinal cord CPG} % The short title appears at the bottom of every slide, the full title is only on the title page

\author[Max Talanov]{
  % \includegraphics[height=2cm]{ITIS_logo_bright}\\
  Max Talanov
} 
\institute[B-Rain Labs LLC]% Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
B-Rain Labs LLC \\ % Your institution for the title page
\medskip
\textit{max.talanov@gmail.com} % Your email address
}
\date{Neuroenhancement and Neuromodulation, Skoltech} % Date, can be changed to a custom date

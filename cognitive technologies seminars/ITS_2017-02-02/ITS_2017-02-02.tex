...
\title[Robot dream]{Neuromorphic Robot Dream} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\item Implementation: Spiking Neural Network (sNN) 
\end{itemize}
...
\begin{itemize}
 \item Emotional robots proof of concept 
 \item Conscious robots
 \item Social robots
\end{itemize}

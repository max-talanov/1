...
\author{Larisa Safina} % Your name
\institute[IU] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Software engineering IU \\ % Your institution for the title page
\medskip
\textit{safinalrr@gmail.com} % Your email address
}
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{dopamine_diagram}
\end{figure}
\end{frame}
...
\begin{itemize}
\item Lövheim, H. (2012). A new three-dimensional model for emo- tions and monoamine neurotransmitters,

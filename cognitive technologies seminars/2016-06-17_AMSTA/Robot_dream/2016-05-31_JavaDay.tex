...
\title[Emotional computers]{Why do computers need emotions?} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Max Talanov} % Your name
\institute[KFU] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Intellectual Robotics ITIS KFU \\ % Your institution for the title page
\medskip

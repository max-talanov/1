...
* 2013 RIKEN developed model (NEST) of 1% of human brain using 250 supercomputer "K". The simulation was 1000 times slower than
real brain.
* 2015 Human brain project specialists developed model of mouse brain using 25 petaflops.
* 2015 Human brain project specialists announced that human brain model would require 10 exaflops.

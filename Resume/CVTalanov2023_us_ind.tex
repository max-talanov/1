...
%\cvitem{Research Gate}{https://www.researchgate.net/profile/Max\char`_Talanov}
    ...
    {I am a highly productive project manager with broad experience in international project management in several countries: the UK, Sweden, Finland, France, for customers including NHS, RCUK, Volvo, Nokia, Auchan.
      As the CRO (2020 -- 2022) in the B-Rain startup company I managed flagship project of neuromorphic neuroprosthesis device with internationally recognized results. 
      Earlier I have been managing the Neuromorphic computing and Neurosimulations laboratory for the last six years leading breaking-through projects in augmented AI, robotics, and neuromorphic computing (see below). I have started the Neuromorphic computing and neurosimulation laboratory in 2014 with one bachelor student and in 2021 we published papers in world leading journals including: Chaos, Solitons \& Fractals, Frontiers in Computer Science, Frontiers in Neuroscience, Frontiers in Cellular Neuroscience, Nature Scientific Reports.
    I have wide industrial experience as manager and technical leader R\&D projects as well as software design architect: eight years in international industrial projects in Fujitsu.}
    \cvitem
        {Strengths}{\small Highly innovative and effective manager of heterogeneous and distributed research and development teams, having a multidisciplinary mindset in computer science, IT, cognitive science, neuroscience, electronics, philosophy.
          I have managed several research projects in Fujitsu GDC Russia including incident automation processing in infrastructure support during 2013-2014 long before ChatGPT.
          Building neuromorphic computing laboratory from 0 to internationally recognized results and papers during 7 years.
        }
...
\cventry[1em]{2022-current}{Senior Research Associate}{}{Institute for Artificial Intelligence. Novi Sad. Serbia}{}
        {Managing and leading multidisciplinary breakthrough research in neuromorphic computing, memristive computing, neurosimulations including real-time, neurointerface. Leading European grant applications and publication activities. Managing European grant applications up to 7 institutions.
          In collaboration with: Istituto dei Materiali per l'Elettronica ed il Magnetismo, CNR, Italy, University of Eastern Finland, Unconventional computing lab of the University of Western England, Universitat Aut\'onoma de Barcelona, Universit\'{a} degli Studi di Messina; scientists: Victor Erokhin, Rashid Giniatullin, Andrew Adamatzky, Jordi Vallverd\'{u}, Salvatore Distefano.}
    
    \cventry[1em]{2020-current}{Associate professor (docent) at Intelligent robotics department}{}{Kazan Federal University}{}
    ...
    \cventry{2020-2022}{CRO}{}{B-Rain labs LLC}{}
            {Managed flagship project of the company from the foundation of the company till functional prototype of the neurosimulation neuroprosthesis, this result was demonstrated in several conferences. We have already used it as laboratory prototype for the research purposes as neurointerface and for compensation of spasticity. Overall duties: management of R\&D projects,
              establishing research and development strategy, research networking with other companies, international communications, and collaborations. Management distributed heterogeneous team of researchers and developers using agile methodologies, motivation, planning, and budgeting.
     ...
     \cventry[1em]{2014-2020}{Head of Neuromorphic computing and neurosimulation laboratory in Institute of Information Technology and Intelligent Systems}{}{KFU}{}{Managed the laboratory including leading multidisciplinary break-through research in neuromorphic computing, computational neurobiology with results published in world leading journals: Chaos, Solitons \& Fractals, Frontiers in Computer Science, Frontiers in Neuroscience, Frontiers in Cellular Neuroscience, Nature Scientific Reports. Started with 1 bachelor student in 2014 and in 2021 we published 5 articles in leading journals including Nature Scientific Results. Attracted 4 grants in the laboratory for the budgeting from 2014 to 2021. Main duties included: grant applications, publication activities; managing bachelor and master students; international communications and collaborations. In collaboration with research centers: the University of Eastern Finland, INSERM; scientists: Roustem Khazipov, Rashid Giniatullin.}
...
\cvitem{2023-Now, KFU}{\small \emph{Neurotechnologies and TRIZ}: the introduction in theory of inventive problems solving (TRIZ) and neurtechnologies including:
artificial neural networks, spiking neural networks, memristive technologies, machine learning and reinforcement learning, natural language processing, intelligent agents. During the course students should develop the neurotechnological project using approaches and technologies discussed in the course.}
    ...
    Chaos, Solitons \& Fractals, Frontiers in Computer Science, Frontiers in Neuroscience, Frontiers in Cellular Neuroscience, Nature Scientific Reports.

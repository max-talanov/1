...
\cvitem{Spinal cord segment prosthesis (2019-now)}
       {\small The project is dedicated to the reimplementation of walking pattern generators of a mammalian spinal cord via memristive electronic schematic for patients with complete spinal cord trauma.
  \emph{Breakthrough}:
...
% correct below to memristive neuron
\cvitem{Memristive neuro prosthesis (2017-now)}{\small The project is dedicated to the reimplementation of walking pattern generators of a mammalian spinal cord via memristive electronic schematic for patients with complete spinal cord trauma.
  \emph{Breakthrough}:
  \emph{Cyberisation of bodies}: first time the bio-compatible part of the nervous system (spinal cord segment) will be re-implemented as memristive electronic schematic reproducing its functionality.
  \emph{Machine to brain interface}: first time the self-adaptive and self-learning interface to integrate electronic devices with a mammalian nervous system is proposed.
  \emph{Robotics}: the reimplementation of a part of a mammalian nervous system compatible with modern electronics could be understood as the significant step towards standalone intelligent robotic systems operating real-time.

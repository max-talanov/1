...
\section{Projects}
%rework
\cvitem{Neuro-simulation neuroprosthesis (2019-now)}
       {\small The project is dedicated to the reimplementation of walking pattern generators of a mammalian spinal cord via neurosimulation for patients with complete spinal cord trauma.
  \emph{Breakthrough}:
...
\cvitem{Memristive CPG (2017-now)}{\small The project is dedicated to the reimplementation of walking pattern generators of a mammalian spinal cord via memristive electronic schematic for patients with complete spinal cord trauma.
  \emph{Breakthrough}:
  \emph{Cyberisation of bodies}: first time the bio-compatible part of the nervous system (spinal cord segment) will be re-implemented as memristive electronic schematic reproducing its functionality.
  \emph{Machine to brain interface}: first time the self-adaptive and self-learning interface to integrate electronic devices with a mammalian nervous system is proposed.
  \emph{Robotics}: the reimplementation of a part of a mammalian nervous system compatible with modern electronics could be understood as the significant step towards standalone intelligent robotic systems operating real-time.
...
\cventry{current}{Head of neuromorphic computing and neurosimulations laboratory}{}{Kazan Federal University}{}
...
\cventry{2006-2014}{Software Design Architect}{}{Fujitsu GDC Russia}{}{Leading several R\&D projects in several domains affective computing, machine cognition, machine learning, code generation automation, natural language processing in several countries including UK, Sweden, Finland, France.

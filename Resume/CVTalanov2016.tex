...
\section{Projects}
\cvitem{Memristive brain (2016-now)}{Sub-project of Robot Dream project dedicated to bio-plausible memristive implementation of a mammalian: neurons capable of inhibition and neuromodulation, brain circuits and brain areas capable of real-time emotional processing in a robotic system}
\cvitem{NEUCOGAR (2014-now)}{\small Neurobiologically inspired cognitive architecture for simulation of neurobiologically plausible emotions in a computational and robotic systems based on spiking neural network simulations}
\cvitem{Robot Dream (2015-now)}{Two phase emotional experience collection, processing and behavioral strategy update based on spiking neural network simulations and memristive implementation of a mammalian brain circuits in a robotic system}

...
\begin{document}
  ...
  \ecvbigitem{Job applied for}{Associate professor}
  ...
  \ecvitem{}{Management of the scientific group; leading multidisciplinary breakthrough research in: meromorphic computing, neurosimulations, affective computing, neurobiologically inspired systems, computational neurobiology and management of grant applications, publication activities; managing bachelor and master students, international communications and collaborations. In collaboration with research centres: CNR IMEM, Incerm INMED, Mayo Clinic, UWE, UEF, Lanzhou University, Universit\'{a} degli studi di Parma, Universitat Aut\'onoma de Barcelona; scientists: Victor Erokhin, Igor Lavrov, Roustem Khazipov, Andrew Adamatzky, Jordi Vallverd\"{u}, Hu Bin, Philip Moore, Salvatore Distefano.}
  ...
  \ecvblueitem{Awards}{
    \emph{2005} - Honorary diploma of the Sun microsystems, Java projects competition, for the MILK - domain specific language for web sites creation.

	\emph{2017} - Best paper award for the article  Spiking reasoning system. Conference DESE-2017.

    \emph{2018} - My proposal has been awarded the Marie Sklodowska-Curie Actions Seal of Excellence. This quality label is awarded to all proposals submitted to the MSCA Individual Fellowships.
    
    \emph{2018} - Best poster award for the abstract: Bio-plausible model of electronic memristive neuron. Conference ESCI-2018.
  }
  
  \ecvblueitem{Grants}{\emph{Memristive spinal cord prosthesis} project received funding according to the Russian Government Program of Competitive Growth of Kazan Federal University.

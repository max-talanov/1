...
\cvitem{2016-2017, Kazan Federal University}{\small Artificial intelligence Introduction: the introduction in artificial intelligence including: machine learning and reinforcement learning, decision making, reasoning, knowledge bases and representations, natural language processing, intelligent agents. During the course students should develop the AI project using principles and technologies discussed in the course.}
...
\nocite{talanov_2015,vallverdu_2016a,jordi2016importance}

%\begin{btSect}[defaultbib]{my_papers}
%  \btPrintCited
  %\section{Papers}
%  \btPrintAll
%\end{btSect}

% Selected works (my_papers.bib)
\bibliographystylesel{spmpsci}
\bibliographysel{my_papers}
...
\cvitem{2017}{\small BICA}
\cvitem{2017}{\small ICAROB}
\cvitem{2017}{\small ICINCO}
...
\cvitem{Spiking NN, Reasoner}{NEST, Neuron, open NARS, OpenCog.PLN, Pellet}
...
\cvcomputer{English}{Full professional proficiency}{}{}
\cvcomputer{Russian}{Mother tongue}{}{}

...
\cvitem{QME (2015-now)}{\small Quantitative model of emotions based on neuromodulatory model of affects or ``cube of emotions'' by Hugo L\"{o}vheim implemented in the spiking neuronal network NEST.}

\cvitem{BioDynaMo (2015-now)}{\small HPC framework of the bio-plausible dynamic, growing neural tissues with  of a mammalian growing brain.}

\cvitem{GDP (2015-now)}{\small The bio-plausible simulation of a hippocampus Giant Depolarizing Potentials with bio-plausible mathematical models of neurobiological processes.}

...
\cvitem{Memristive spinal cord segment prosthesis (2016 -- now)}{\small The bio-mimetic memristive implementation of a mammalian spinal cord circuits in a electronic system as a prosthesis, based on polyaniline memristive neurons implementation capable of inhibition and neuromodulation.
...
\href{https://github.com/research-team/cellCircuit}{\emph{Project site}}.
  ...
  \cvitem{Multi-compartment nociceptive ATP signaling (2017 -- now)}{The neuro-simulation of ATP signaling and spikes auto-generation in sensory fibers.

  }
  
  \cvitem{\ecvhighlight{In collaboration with:}} {Rashid Ginniatullin from University of Eastern Finland.}
...
...
\cvitem{}{\emph{Neuroscience}: First time the prolonged auto-generation of spikes triggered by ATP will be demonstrated via bio-plausible neuro-simulation.}

...
\cvitem{Nociceptive ATP signaling (2017 -- now)}{The neuro-simulation project of an ATP signaling and spikes auto-generation in sensory fibers of mammalian cells using neurosimualtory environment Neuron, model of diffusion and different models of sodium, potassium ion channels.
...
\cvitem{Nociceptive ATP signaling}{\emph{Neuroscience}: First time the prolonged auto-generation of spikes triggered by ATP will be demonstrated via bio-plausible neuro-simulation.}

...
\section{Engaging Students with Active Learning}
\cvitem{}{
  Currently when students can find tons of the educational information on the net regarding not only IT related but for example biology related topics, it seems that the role and importance of lecturer or teacher is vanishing in past. This way I try hard to encapsulate online resources including: books, videos, interactive courses, articles and even Wikipedia in the courses I create. 
  Starting form my return to academia from GDC Fujitsu Russia in 2014 I have used interactive approach in all my courses. Because I'm the original author of all the courses I teach it brings the flexibility of the contents and interaction with students. This way I dynamically increase or decrease the complexity of the material even during one class. The in class interaction provides basic necessary influence to manage the motivation and expectations of students. I used flipped class to deliver all courses to mix practical and theoretical aspects of the courses and make interaction with students cornerstone of the class. Starting from the second class students have an option to actively participate not only in form of seminars but delivering their understanding of the material and progress of the semester project via presentation and questioning other students. All my courses are project based this allows students to gain hands-on experience not only by reading materials but also tiring and solving problems with different approaches. I consider as important to provide students with extra information regarding the practical use, problems and limitations of the approaches, algorithms data structures described in the course not limiting to text books or tutorials that they could find online.
}

...
\cventry
    {Bio}{Highly-creative cognitive researcher with broad research experience}{}{}{}{Self motivated highly productive ideas generator with broad experience in: \ldots affective computing, neurobiological simulations, bio-inspired cognitive architectures, neuromorphic computing, artificial intelligence, natural language processing, probabilistic reasoning. I'm heading projects for 4 years managing breaking-through projects (see below).\\
     \ldots Currently I have the position of the deputy director for science of the Information Technology and Information Systems institute (ITIS) of the Kazan Federal University, where I manage research, grants and publication policies.\\
    \ldots  As well as I'm the head of neurotechnology projects at neuroscience laboratory managing multidisciplinary projects in: affective computing, computational neuroscience, neuromorphic computing (electronics, memristive devices), biologically inspired cognitive architectures.\\
...
\cvitem{Memristive spinal cord segment prosthesis (2017-now)}{\small Project dedicated to the reimplementation of walking pattern generators of a mammalian spinal cord via memristive electronic schematic for patients with spinal cord trauma.
  \emph{Breakthrough}:
  \emph{Machine to brain interface}: first time the bio-plausible implementation of .
  \emph{Cyberisation of bodies}: first time the bio-plausible emotional drives will be implemented to form behavioral strategies of an artificial system. We have already demonstrated: ``fear-like'' and ``disgust-like'' states.
  \emph{Robotics}: \ldots{}
...
\cvitem{TU (2012-2017)}{\small Thinking-Understanding. The cognitive architecture implementing the approach of the intelligent system for a help desk automation based on: machine cognition: natural language processing (NLP), probabilistic reasoning and ``Model of six'' the model of human mental processes by Marvin Minsky}
...
Salvatore Distefano, Messina University, salvatdi@gmail.com, +390903977318

...
\begin{frame}
\frametitle{DA results: disgust-like}
\begin{figure}
\includegraphics[width=0.6\linewidth]{5ht_results}
\end{figure}
400 ms - simulated brain in placed in the ``fear-like'' state;
600 ms - simulated brain in placed in the ``disgust-like'' that is indicated with decreased level of neuronal activity on motor cortex and decreased computational power consumption.
\end{frame}

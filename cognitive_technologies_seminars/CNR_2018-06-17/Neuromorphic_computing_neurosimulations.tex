...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=0.48\linewidth]{epidural_stimulation_spinal_cord}
  \end{figure}
\end{frame}
%------------------------------------------------
\begin{frame}
...
%------------------------------------------------
\subsection{STDP results}
%------------------------------------------------

\begin{frame}
\frametitle{STDP: Hebbian, Sin}
\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
...
\begin{frame}
\frametitle{STDP: Sombrero, anti-Hebbian}
\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment

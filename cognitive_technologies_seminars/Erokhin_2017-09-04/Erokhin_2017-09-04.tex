...
\begin{itemize}
\item \emph{ICO}: Initial coin offering; 
\item \emph{Ak Bars Bank}: 9m rubles as investment.
\end{itemize}
\end{frame}
%------------------------------------------------
...
\begin{itemize}
\item Technical report of each significant result to arxiv.org;
\item Later article to Science, Nature?;
\item US patent?
\end{itemize}
\end{frame}
